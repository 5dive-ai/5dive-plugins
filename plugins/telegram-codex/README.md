...
- v0.1.9 — `Notification` hook relays error-flavored notifications (rate limit, API failure, timeout) to Telegram with a `⚠️ codex: …` prefix. Relay-all override via `CODEX_NOTIFY_RELAY_ALL=1`; disable via `CODEX_NOTIFY_RELAY_DISABLED=1`. (this)
