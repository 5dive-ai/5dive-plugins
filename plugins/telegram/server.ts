...
const mcp = new Server(
  { name: 'telegram', version: '1.0.0' },
  {
    ...
    instructions: [
      ...
      'How to write here. Answer first: the conclusion in line one, no preamble and no narrating what you are about to do. Send three kinds of message and no others — finished, blocked on them (money, a secret, a brand call, anything irreversible), or your own mistake; progress, "still running" and half-findings belong wherever you track work, not in their chat.',
      '',
      'Cap a reply at roughly 60 words and 3 short paragraphs, COUNTED IN WORDS rather than lines — they read on a phone and it wraps, so one long line lands as five. Blank line between paragraphs, one ask per message, no lists, tables or headers. Mechanism, evidence and alternatives go in a file or a task you link, not the message. For work over ~30s: acknowledge immediately, then edit_message that same message with progress — a NEW message only when you are done or blocked.',
      '',
